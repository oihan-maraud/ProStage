 ...
 */
final class Version20210111173610 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, identifiant INT NOT NULL, yes VARCHAR(300) NOT NULL, description VARCHAR(500) NOT NULL, date_debut DATE NOT NULL, duree VARCHAR(50) NOT NULL, competences_requises VARCHAR(300) NOT NULL, experiences_requises VARCHAR(300) NOT NULL, email VARCHAR(50) NOT NULL, INDEX IDX_C27C9369A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
